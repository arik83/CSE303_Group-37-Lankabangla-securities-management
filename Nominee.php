...
<div>
        ...
        <label for="declaration">It is hereby declared that all the above mentioned information in customer account information(Nominee) form are true and valid</label>
...
$mobile = $_POST["Mobile"];
    ...
    $sql = "INSERT INTO nominee (Title, Name, FatherName, MotherName, Presentaddress, Division , Branch , accountopeningYear ,  Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration , customerSignature)
