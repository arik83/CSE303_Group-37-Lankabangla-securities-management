...
<div>
        ...
        <label for="declaration">It is hereby declared that all the above mentioned information in customer account information(Authorized Person Information) form are true and valid</label>
...
$mobile = $_POST["Mobile"];
    ...
    $sql = "INSERT INTO authorizedpersoninformation (Title, Name, FatherName, MotherName, Presentaddress, Division , Branch , accountopeningYear ,  Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration , customerSignature)
