...
<body>
    ...
    <div class="container">
        <h1 class="mt-4">Depository Account Application(Joint Applicant)</h1>
...
$mobile = $_POST["Mobile"];
    ...
    $sql = "INSERT INTO  boaccountjointapplicant (BOID,Title, Name, FatherName, MotherName, Presentaddress, Division , Branch , accountopeningYear ,  Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration , customerSignature)
