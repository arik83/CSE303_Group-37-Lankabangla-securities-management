...
<body>
    ...
    <div class="container">
        <h1 class="mt-4">Depository Account Application(First Applicant)</h1>
...
<div>
        ...
        <label for="declaration">It is hereby declared that all the above mentioned information in BO account information(Jointapplicant) form are true and valid</label>
...
$mobile = $_POST["Mobile"];
    ...
    $sql = "INSERT INTO  boaccountfirstapplicant (BOID,Title, Name, FatherName, MotherName, Presentaddress, Division , Branch , accountopeningYear ,  Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration , customerSignature)
    VALUES ('$BOid','$title', '$name', '$fatherName', '$motherName', '$presentAddress', '$division' , '$branch' , '$AccountopeningYear', '$mobile', '$email', '$etin', '$nid', '$dateOfBirth', '$occupation', '$gender', '$nationality', '$residency', '$declaration', '$customersignature')";
